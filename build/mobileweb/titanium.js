...
var require = {
	app: {
		...
		description: "Coin Toss game",
		guid: "e4e3d502-6b7b-46f6-965e-7a3f61693143",
		id: "CoinToss",
		name: "CoinToss",
		names: {},
	...
	project: {
		id: "br.com.editoraphoenix.cointoss",
		name: "CoinToss"
	},
	ti: {
		buildHash: "999c68a",
...
p.setString("acs-api-key-production","p7RZ6DvjVlZeE5dj8T1WIHocDacKrq0W");
p.setString("acs-api-key-development","npRVt6FONc2EswsUT5iXj80JgcpZvRz7");
p.setString("acs-oauth-secret-development","pJhh867u9rqdXDEdCD4oC353rQ5pkn33");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","n4sVREJKtLFZEQRU3vW8oElKVu9UNGbw");
p.setString("acs-oauth-key-development","tl0bRtAeykSFxjotxIbKuOpJODkTjJM1");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","BY3C8Waq64nK4etiKBCSvzo78hxrBpJt");
});
