...
// in simulator we redefine to format for CoinToss Developer console
...
{\
	NSString * exceptionName = [@"org.cointoss." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cointoss";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UICoinTossNativeItemNone = -1, 
	UICoinTossNativeItemSpinner = -2,
	UICoinTossNativeItemProgressBar = -3,
	
	UICoinTossNativeItemSlider = -4,
	UICoinTossNativeItemSwitch = -5,
	UICoinTossNativeItemMultiButton = -6,
	UICoinTossNativeItemSegmented = -7,
	
	UICoinTossNativeItemTextView = -8,
	UICoinTossNativeItemTextField = -9,
	UICoinTossNativeItemSearchBar = -10,
	
	UICoinTossNativeItemPicker = -11,
	UICoinTossNativeItemDatePicker = -12,
	
	UICoinTossNativeItemInfoLight = -13,
	UICoinTossNativeItemInfoDark = -14,
	
	UICoinTossNativeItemDisclosure = -15,
	
	UICoinTossNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CoinToss instances of
