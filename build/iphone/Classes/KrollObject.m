 ...
 * Copyright (c) 2009-2011 by CoinToss, Inc. All Rights Reserved.
...
//@interface CoinTossObject : NSObject
//@end

@interface CoinTossObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CoinTossObject class]])
		{
			for (NSString *key in [[(CoinTossObject*)o modules] allKeys])
			{
