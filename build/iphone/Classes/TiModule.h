...
/**
 The base class for all CoinToss modules
 */
...
/**
 CoinToss Platform calls this method on startup.
 */
-(void)startup;

/**
 CoinToss Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 CoinToss Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 CoinToss Platform calls this method on resume.
 @param sender The sender of the event.
 */
